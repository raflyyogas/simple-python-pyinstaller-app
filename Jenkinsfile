    ...
    try {
        ...
        if (userInput == 'Proceed') {
            stage('Deploy') {
                ...
                sh "docker run --rm -v /var/jenkins_home/workspace/submission-cicd-pipeline-raflyyogas/sources:/src cdrx/pyinstaller-linux:python2 /bin/sh -c 'pyinstaller -F /src/add2vals.py'"
